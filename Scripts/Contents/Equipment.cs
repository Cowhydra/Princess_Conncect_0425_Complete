...
public class Equipment
{
    ...
    public bool Equip(Item equipitem)
    {
        ...
        if (!Managers.CharacterInventory.MyCharacters[Character_Code].IsActive)
            return false;
        ...
        else
        {
            ...
            Refresh();
            Managers.CharacterInventory.MyCharacters[Character_Code].InvenUI_ReFresh?.Invoke();
            return true;
        }
    }
        ...
        foreach (var s in EQUIP.Keys)
        {
            switch (s)
            {
                ...
                case ItemType.Necklace:
                    Item.Necklace necklace = EQUIP[s] as Item.Necklace;
                    EQUIP_MaxMp += necklace.MaxMp;
                    EQUIP_Attack += necklace.Attack;
                    EQUIP_MpRecovery += necklace.MpRecovery;
                    break;
                case ItemType.Accessory:
                    Item.Accessory accessory = EQUIP[s] as Item.Accessory;
                    EQUIP_MaxMp += accessory.MaxMp;
                    EQUIP_HpRecovery += accessory.HpRecovery;
                    EQUIP_Def += accessory.Def;
                    EQUIP_AttackRange += accessory.AttackRange;
                    break;
                case ItemType.Ring:
